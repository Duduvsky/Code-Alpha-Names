...
export default function LandingPage({ onStart }: LandingPageProps) {
  ...
  return (
    <div className="bg-gray-900 text-white">
      {/* Header */}
      <header className="sticky top-0 z-50 backdrop-blur bg-gray-800 bg-opacity-90 border-b flex justify-between items-center px-6 py-4">
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="sticky top-[65px] left-0 w-full px-6 pb-4 z-40 bg-gray-800 text-white">
      ...
      {/* COMO JOGAR */}
      <section id="about" className="py-20 px-6 max-w-4xl mx-auto rounded-lg shadow-lg bg-gray-800">
      ...
      {/* EQUIPE */}
      <section id="team" className={`py-16 px-6 mt-10 bg-gray-800`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            <p className={`text-sm mt-2 text-gray-400`}>Backend e Websocket + lógica em tempo real do jogo. </p>
          </div>
          <div className="flex flex-col items-center text-center">
            ...
            <p className={`text-sm mt-2 text-gray-400`}>Frontend e integração com Backend + Gerência de Projeto</p>
          </div>
        </div>
        <p className={`text-center mt-12 italic text-sm text-gray-400`}>
