    ...
    <div className="min-h-screen flex flex-col p-4 bg-gray-100 relative">
      ...
      <div className="flex justify-between items-center mb-4 flex-wrap gap-4">
        {!gameStarted && (
          <div className="flex items-center gap-4 flex-wrap">
            <button onClick={handleStartGame} className="px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition">
              Iniciar Jogo
            </button>
            <p className="text-gray-600">Aguarde todos confirmarem</p>
          </div>
        )}
        <button onClick={onExit} className="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition">
          Sair do Jogo
        </button>
      </div>
      ...
      <div className="flex-1 bg-white p-4 rounded-lg shadow overflow-y-auto">
        ...
        <div className="flex gap-2">
          <input type="text" placeholder="Digite sua mensagem..." className="flex-1 p-2 border border-gray-300 rounded-lg" />
          <button className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition">Enviar</button>
        </div>
      </div>
    </div>
  );
